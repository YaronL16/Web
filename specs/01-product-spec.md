...
- **Visuals:** Dark carbon background with amber/cyan gradient glow and human user icon (`User`). Badge displays `"YARON (HUMAN)"` to establish the human engineer's authentic personal voice. Dismissible via close button.
